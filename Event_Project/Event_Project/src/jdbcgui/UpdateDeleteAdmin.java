...
public class UpdateDeleteAdmin extends javax.swing.JFrame {
    ...
    public UpdateDeleteAdmin(LoginUser user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Login Admin");
    ...
    void getNewData() {
        ...
        try {
            ...
            rs = dbCon.executeStatement("SELECT * FROM \"USER\" JOIN admin ON userid = adminid ORDER BY userid ASC ");
            rs.beforeFirst();
            rs.first();
            populateFields();
    ...
    boolean isValidData() throws SQLException {
        ...
        if (txtOfficeLoc.getText().trim().isEmpty() || (txtOfficeLoc.getText().trim().length() > 30)) {
            ...
            } else if ((txtOfficeLoc.getText().trim().length() > 30)) {
    ...
    private void btnUpdateUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateUserActionPerformed
        ...
        try {
            ...
            if (isValidData()) {
                ...
                String prepSQL2 = "UPDATE admin SET officeloc = ?, phoneno = ? WHERE adminid = ?";
                ...
                if (result > 0 && result2 > 0) {
                    ...
                    String action = "Updated: Admin with id " + txtUserID.getText().trim();
                    updateLogs(action);

                    javax.swing.JLabel label = new javax.swing.JLabel("Admin " + txtUserID.getText() + " updated successfully.");
                    label.setFont(new java.awt.Font("Arial", java.awt.Font.BOLD, 18));
    ...
    private void btnDeleteUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteUserActionPerformed
        ...
        try {
            ...
            String prepSQL = "DELETE admin WHERE adminid = '" + currentUserID + "'";
            ...
            if (result > 0 && result2 > 0) {
                ...
                String action = "Deleted: Admin with id " + txtUserID.getText().trim();
                updateLogs(action);

                javax.swing.JLabel label = new javax.swing.JLabel("Admin " + currentUserID + " deleted successfully.");
                label.setFont(new java.awt.Font("Arial", java.awt.Font.BOLD, 18));
                JOptionPane.showMessageDialog(null, label, "SUCCESS", JOptionPane.INFORMATION_MESSAGE);
                getNewData();
            }
